...
namespace Smis.Migrations
{
    ...
    [Migration("20250930073016_AddMbrojtja")]
    partial class AddMbrojtja
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smis.Models.AfatiProvimit", b =>
                {
                    b.Property<int>("AfatiProvimitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AfatiProvimitId"));
                    ...
                    b.HasKey("AfatiProvimitId");

                    b.HasIndex("DepartamentiId");

                    b.ToTable("AfatiProvimit");
                });

            modelBuilder.Entity("Smis.Models.AfatiRegjistrimit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TipiSemestrit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Smis.Models.Fabrika", b =>
                {
            ...
            modelBuilder.Entity("Smis.Models.Puntori", b =>
                {
                    b.Property<int>("PuntoriId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PuntoriId"));
            ...
            modelBuilder.Entity("Smis.Models.ParaqitjaEprovimit", b =>
                {
                    b.HasOne("Smis.Models.AfatiProvimit", "Afati")
                        .WithMany()
                        .HasForeignKey("AfatiProvimitId");
            ...
            modelBuilder.Entity("Smis.Models.Puntori", b =>
                {
                    b.HasOne("Smis.Models.Fabrika", "Fabrika")
                        .WithMany("Puntori")
            ...
            modelBuilder.Entity("Smis.Models.Universiteti", b =>
                {
                    ...
                    b.Navigation("AfatetRegjistrimit");
