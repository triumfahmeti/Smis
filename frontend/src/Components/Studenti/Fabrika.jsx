...
const Fabrika = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axiosClient.post("/fabrika", {
        emri,
        lokacioni,
        shteti,
      });
      setAlertType("success");
      setAlertMessage("Fabrika u shtua me sukses.");
      setEmri("");
      setLokacioni("");
      setShteti("");
    } catch (err) {
      setAlertType("danger");
      setAlertMessage("Gabim gjatë shtimit të Fabrikës.");
      console.error(err);
    }
  };
        ...
        <div id="layoutSidenav_content">
          <main>
            <div className="container-fluid px-4">
              <h2 className="mt-4">Menaxhimi i Fabrikave</h2>
              <ol className="breadcrumb mb-4">
                <li className="breadcrumb-item">
                  <Link to="/student/profili">Home</Link>
                </li>
                <li className="breadcrumb-item active">Fabrika</li>
              </ol>
              {alertMessage && (
                <div
              ...
              <div className="card mb-4">
                <div className="card-header">
                  <i className="fa-solid fa-industry me-1"></i>Shto Fabrike
                </div>
                <div className="card-body">
                  <form onSubmit={handleSubmit} className="row g-3">
                    <div className="col-md-6">
                      <label className="form-label">Emri i Fabrikës</label>
                      <input
                        type="text"
